...
/*   Updated: 2025/09/02 09:04:22 by tfarkas          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static void	choose_object_checkboard(t_hit *hit,
	float *u_scaled, float *v_scaled)
{
	t_sphere	*sphere;
	t_plane		*plane;
...
t_color_float	checkboard_pattern(t_hit *hit)
{
	...
	u_scaled = 0.0;
	v_scaled = 0.0;
	color_float_set(&white, 1.0, 1.0, 1.0);
	color_float_set(&black, 0.0, 0.0, 0.0);
	choose_object_checkboard(hit, &u_scaled, &v_scaled);
