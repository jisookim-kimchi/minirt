...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2025/08/30 16:31:43 by jisokim2          #+#    #+#             */
/*   Updated: 2025/08/30 16:43:38 by jisokim2         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
*/
void	get_local_axes(const t_rotator *rot,
	t_vec3 *outRight, t_vec3 *outUp, t_vec3 *outForward)
{
