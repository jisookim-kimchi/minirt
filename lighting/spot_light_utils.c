...
/*   Updated: 2025/08/30 19:23:41 by tfarkas          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
/*
	t_spot_light	init_spot_light(t_spot_light *light, t_vec3 direction, 
		float distance, float angle, float intensity)
	{
		...
		{
			printf("Wrong input for point_light so we give 
				DEFAULT point_light\n");
